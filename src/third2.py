...
#agent = regular.regularagent()   #oRIGINALMENTE ERA ESSE
#agent = aDrqn.drqnagent()
#agent = rand.randomagent()
#agent.targetnet.network.save('86-DRQNTANHfourth10000.h5')
...
agent.targetnet.network.save(str(run)+'-DrQN30001.h5')